...
const checkoutData = () => {
	...
	const paypalScript = () => {
		...
		script.src =
			"https://www.paypal.com/sdk/js?client-id=AXVI2kKwKf_TzwdXLcLSsP7PjlSri4vGTvYO8Av0ZeKvQXmezxsAScuQdLCs-zhxfbWGXuIm5O9JhIle";
	...
	const makePayment = async (token) => {
		...
		try {
			...
			if (data.error) {
				...
				toast.success(
					"Order Successfully Created. Check email for details"
				);
			...
			<div className="row">
				{cart.length !== 0 ? (
					...
					<div className="text-center text-danger fs-4">
						<ShoppingCartOutlined className="fs-2" /> Cart
						is Empty
					</div>
				)}
				{cart.length !== 0 && (
					<div className="text-center">
						<StripeCheckout
							stripeKey={
								process.env.NEXT_PUBLIC_STRIPEPUBLISHERKEY
							} // publisher key
							token={makePayment}
							name="Buy Ticket"
