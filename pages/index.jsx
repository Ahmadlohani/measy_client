		...
		<div>
			...
			<div className="row" style={{ marginTop: "100px" }}>
				<div className="text-center">
					<Zoom delay={1000} duration={2000}>
						<span className="fs-3 fw-bolder text-white headingBorder">
							EVENTS
						</span>
					</Zoom>
				</div>
			...
			<Container>
				<Tabs
					...
					className="justify-content-center p-3 mb-3 border-0"
				>
								...
								<Link href={`/event/12345`}>
									...
									>
										...
										<Card.Body className="bg-primary text-white">
											...
											<Card.Text>
												This is a social media site where
												you can create posts. Add Images and
								...
								<Link href={`/event/12345`}>
									...
									>
										...
										<Card.Body className="bg-primary text-white">
											...
											<Card.Text>
												You can follow others. See their
												Posts and comment on Posts to
												deliver what you feel about them.
											</Card.Text>
										</Card.Body>
									</Card>
								</Link>
								...
								<Link href={`/event/12345`}>
									...
									>
										...
										<Card.Body className="bg-primary text-white">
											...
											<Card.Text>
												Login for best User Experience. Feel
